...
struct retro_core_option_v2_definition option_defs_us[] = {
	{
		"pzretro_custom_font",	/* key (option name) */
		"Anti-Aliased Font",	/* description (label) */
		NULL,					/* 'categorised' description */
		"Use the custom anti-aliased font. Can have an impact on performance. Requires a restart.",	/* sublabel */
		NULL,					/* 'categorised' sublabel */
		NULL,					/* category key */
		{
			{ "off", NULL },	/* value, label */
			{ "on", NULL },
			{ NULL, NULL },
		},
		"off"					/* default value */
